...
<a href="https://skillicons.dev">
  <img alt="Rust, Python, Java, TypeScript, JavaScript, Node.js, React, PostgreSQL, Docker, Linux, Git, PowerShell" src="https://skillicons.dev/icons?i=rust,python,java,ts,js,nodejs,react,postgres,docker,linux,git,powershell&theme=dark&perline=6" />
</a>
